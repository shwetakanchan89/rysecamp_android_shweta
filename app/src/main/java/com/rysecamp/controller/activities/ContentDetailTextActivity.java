...
//        addData();
//        viewPager.setAdapter(new ContentTextImageAdapter(getSupportFragmentManager(), context, stringList));

        RecyclerView recyclerView = findViewById(R.id.recycler_view_content_details);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getApplicationContext());
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setHasFixedSize(true);
        ContentTextImageAdapter contentTextImageAdapter = new ContentTextImageAdapter(getApplicationContext(), new ArrayList<SpotlightDto>());
        recyclerView.setAdapter(contentTextImageAdapter);
        contentTextImageAdapter.add(new LinkedList<SpotlightDto>(Arrays.asList(new SpotlightDto(), new SpotlightDto(), new SpotlightDto(), new SpotlightDto(), new SpotlightDto())));
