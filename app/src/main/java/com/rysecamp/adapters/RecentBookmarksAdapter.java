...
public class RecentBookmarksAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecentBookmarksAdapter(Context context, List<SpotlightDto> dataList) {
        this(context, dataList, null);
    }

    public RecentBookmarksAdapter(Context context, List<SpotlightDto> dataList, ItemClick itemClickListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new RowViewHolder(LayoutInflater.from(context).inflate(R.layout.recent_bookmarks_card_row_item, parent, Boolean.FALSE));
    }
