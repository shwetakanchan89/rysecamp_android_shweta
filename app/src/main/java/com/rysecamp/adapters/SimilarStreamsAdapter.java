...
public class SimilarStreamsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SimilarStreamsAdapter(Context context, List<SpotlightDto> dataList) {
        this(context, dataList, null);
    }

    public SimilarStreamsAdapter(Context context, List<SpotlightDto> dataList, ItemClick itemClickListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new RowViewHolder(LayoutInflater.from(context).inflate(R.layout.similar_streams_card_row_item, parent, Boolean.FALSE));
    }
    ...
    public interface ItemClick {
        ...
        void onSimilarStreamClick(SpotlightDto data, View view);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (itemClickListener != null)
                        itemClickListener.onSimilarStreamClick(data, v);
                }
            });
