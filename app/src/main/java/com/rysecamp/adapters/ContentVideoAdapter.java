...
public class ContentVideoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ContentVideoAdapter(Context context, List<SpotlightDto> dataList) {
        this(context, dataList, null);
    }

    public ContentVideoAdapter(Context context, List<SpotlightDto> dataList, ItemClick itemClickListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new RowViewHolder(LayoutInflater.from(context).inflate(R.layout.fragment_content_video_card, parent, Boolean.FALSE));
    }
