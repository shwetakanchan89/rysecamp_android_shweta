...
public class GoogleAnalyticsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public GoogleAnalyticsAdapter(Context context, List<SpotlightDto> dataList) {
        this(context, dataList, null);
    }

    public GoogleAnalyticsAdapter(Context context, List<SpotlightDto> dataList, ItemClick itemClickListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new RowViewHolder(LayoutInflater.from(context).inflate(R.layout.google_analytics_card_row_item, parent, Boolean.FALSE));
    }
