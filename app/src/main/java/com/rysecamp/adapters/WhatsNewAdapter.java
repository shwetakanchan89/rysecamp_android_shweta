...
public class WhatsNewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public WhatsNewAdapter(Context context, List<SpotlightDto> dataList) {
        this(context, dataList, null);
    }

    public WhatsNewAdapter(Context context, List<SpotlightDto> dataList, ItemClick itemClickListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new RowViewHolder(LayoutInflater.from(context).inflate(R.layout.dashbaord_whatsnew_card_view, parent, Boolean.FALSE));
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (itemClickListener != null)
                        itemClickListener.onItemClickListener(data, v);
                }
            });
