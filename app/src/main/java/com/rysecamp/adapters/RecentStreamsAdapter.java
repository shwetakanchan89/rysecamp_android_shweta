...
public class RecentStreamsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecentStreamsAdapter(Context context, List<SpotlightDto> dataList) {
        this(context, dataList, null);
    }

    public RecentStreamsAdapter(Context context, List<SpotlightDto> dataList, ItemClick itemClickListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new RowViewHolder(LayoutInflater.from(context).inflate(R.layout.recent_streams_card_row_item, parent, Boolean.FALSE));
    }
