...
public class ContentPremiumAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ContentPremiumAdapter(Context context, List<SpotlightDto> dataList) {
        this(context, dataList, null);
    }

    public ContentPremiumAdapter(Context context, List<SpotlightDto> dataList, ItemClick itemClickListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new RowViewHolder(LayoutInflater.from(context).inflate(R.layout.fragment_content_premium_card, parent, Boolean.FALSE));
    }
    ...
    public interface ItemClick {
        void onRecentStreamClick(SpotlightDto data, View view);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (itemClickListener != null)
                        itemClickListener.onRecentStreamClick(data, v);
                }
            });
