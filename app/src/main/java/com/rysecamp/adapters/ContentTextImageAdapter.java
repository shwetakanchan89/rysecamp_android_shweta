...
public class ContentTextImageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ContentTextImageAdapter(Context context, List<SpotlightDto> dataList) {
        this(context, dataList, null);
    }

    public ContentTextImageAdapter(Context context, List<SpotlightDto> dataList, ItemClick itemClickListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new RowViewHolder(LayoutInflater.from(context).inflate(R.layout.fragment_content_text, parent, Boolean.FALSE));
    }
